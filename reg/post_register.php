...
require 'db.php' ;
    ...
    $email_exist ="SELECT COUNT(*) AS total FROM admin_users WHERE email ='$email'";
    ...
    if($flag){
        ...
        $insert = "INSERT INTO admin_users(name, email, password, gender, created_at) VALUES('$name', '$email', '$after_hash', '$gender', '$created_at')";
